...
var app = (function () {
    ...
    /* src\Title.svelte generated by Svelte v3.31.2 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "Keoma Klaver Klein";
    			add_location(h2, file, 3, 4, 57);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("senha" in $$props) $$invalidate(0, senha = $$props.senha);
    	};

    	$$self.$capture_state = () => ({ senha });
    ...
    class Title extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { senha: 0 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "Projeto feito com Svelte.js";
    			add_location(h3, file$1, 4, 0, 55);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Body extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { senha: 0 });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			h2 = element("h2");
    			t5 = text("Contador simples: ");
    			t6 = text(/*counter*/ ctx[1]);
    			t7 = space();
    			button = element("button");
    			button.textContent = "Incremento";
    			t9 = space();
    			create_component(body.$$.fragment);
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file$2, 19, 1, 278);
    			add_location(h2, file$2, 20, 1, 302);
    			add_location(button, file$2, 21, 1, 340);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file$2, 17, 0, 259);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*clicou*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*name*/ 1) set_data_dev(t2, /*name*/ ctx[0]);
    			if (!current || dirty & /*counter*/ 2) set_data_dev(t6, /*counter*/ ctx[1]);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Title, Body, name, counter, clicou });
